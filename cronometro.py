...
label_app = Label(janela, text='Cronômetro',
                  font='Arial 12', bg=cor1, fg=cor2,)
label_app.place(x=20, y=5)

label_tempo = Label(janela, text=tempo,
                    font='times 46 bold', bg=cor1, fg=cor3,)
label_tempo.place(x=90, y=50)

# Botoes

botao_iniciar = Button(janela, command=start, text='Iniciar', width=10, height=2,
                       bg=cor1, fg=cor2, font='Ivy 10 bold', relief='raised', overrelief='ridge')
botao_iniciar.place(x=50, y=150)

botao_pausar = Button(janela, command=pause, text='Pausar', width=10, height=2,
                      bg=cor1, fg=cor2, font='Ivy 10 bold', relief='raised', overrelief='ridge')
botao_pausar.place(x=150, y=150)

botao_reiniciar = Button(janela, command=restart, text='Reiniciar', width=10, height=2,
                         bg=cor1, fg=cor2, font='Ivy 10 bold', relief='raised', overrelief='ridge')
